...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        IslandChainModel andamanIsland = new IslandChainModel("Andaman Islands", india, indianOcean, bassIslandsItinerary, bassIslandsPackList,"https://api.mapbox.com/styles/v1/cstephens/cky2cwav41al814o5n98c52su.html?title=false&access_token=pk.eyJ1IjoiY3N0ZXBoZW5zIiwiYSI6ImNreTJjc2tzYjBqbXQydW1wZ2N0a20zeDYifQ.SkbSfO39uFF6KHu0Jm7ISA&zoomwheel=false#6.36/11.858/92.75");
        islandChainRepo.save(andamanIsland);

        IslandChainModel heardMcDonaldIsland = new IslandChainModel("Heard Island and the McDonald Islands", australiaCountry, indianOcean, bassIslandsItinerary, bassIslandsPackList,"https://api.mapbox.com/styles/v1/cstephens/cky2cwav41al814o5n98c52su.html?title=false&access_token=pk.eyJ1IjoiY3N0ZXBoZW5zIiwiYSI6ImNreTJjc2tzYjBqbXQydW1wZ2N0a20zeDYifQ.SkbSfO39uFF6KHu0Jm7ISA&zoomwheel=false#8.22/-53.066/73.464");
        islandChainRepo.save(heardMcDonaldIsland);

        IslandChainModel galapagosIsland = new IslandChainModel("Galápagos Islands", ecuador, pacificOcean, bassIslandsItinerary, bassIslandsPackList, "https://api.mapbox.com/styles/v1/cstephens/cky2cwav41al814o5n98c52su.html?title=false&access_token=pk.eyJ1IjoiY3N0ZXBoZW5zIiwiYSI6ImNreTJjc2tzYjBqbXQydW1wZ2N0a20zeDYifQ.SkbSfO39uFF6KHu0Jm7ISA&zoomwheel=false#6.63/0.034/-90.377");
        islandChainRepo.save(galapagosIsland);

        IslandChainModel madagascarIsland = new IslandChainModel("Madagascar", madagascarCountry, indianOcean, bassIslandsItinerary, bassIslandsPackList, "https://api.mapbox.com/styles/v1/cstephens/cky2cwav41al814o5n98c52su.html?title=false&access_token=pk.eyJ1IjoiY3N0ZXBoZW5zIiwiYSI6ImNreTJjc2tzYjBqbXQydW1wZ2N0a20zeDYifQ.SkbSfO39uFF6KHu0Jm7ISA&zoomwheel=false#4.63/-19.15/45.99");
        islandChainRepo.save(madagascarIsland);

        IslandChainModel ionianIsland = new IslandChainModel("The Ionian Islands", greece, ionianSea, bassIslandsItinerary, bassIslandsPackList, "https://api.mapbox.com/styles/v1/cstephens/cky2cwav41al814o5n98c52su.html?title=false&access_token=pk.eyJ1IjoiY3N0ZXBoZW5zIiwiYSI6ImNreTJjc2tzYjBqbXQydW1wZ2N0a20zeDYifQ.SkbSfO39uFF6KHu0Jm7ISA&zoomwheel=false#7.62/38.056/20.906");
        islandChainRepo.save(ionianIsland);

        IslandChainModel bermudaIsland = new IslandChainModel("Bermuda Islands", uk, atlanticOcean, bassIslandsItinerary, bassIslandsPackList,"https://api.mapbox.com/styles/v1/cstephens/cky2cwav41al814o5n98c52su.html?title=false&access_token=pk.eyJ1IjoiY3N0ZXBoZW5zIiwiYSI6ImNreTJjc2tzYjBqbXQydW1wZ2N0a20zeDYifQ.SkbSfO39uFF6KHu0Jm7ISA&zoomwheel=false#10.03/32.2878/-64.7677");
        islandChainRepo.save(bermudaIsland);

        IslandChainModel santoriniIsland = new IslandChainModel("Santorini Island", greece, aegeanSea,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#10.31/36.3991/25.4243");
        islandChainRepo.save(santoriniIsland);

        IslandChainModel balearicIsland = new IslandChainModel("Balearic Islands", spain, ionianSea,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/cstephens/cky2cwav41al814o5n98c52su.html?title=false&access_token=pk.eyJ1IjoiY3N0ZXBoZW5zIiwiYSI6ImNreTJjc2tzYjBqbXQydW1wZ2N0a20zeDYifQ.SkbSfO39uFF6KHu0Jm7ISA&zoomwheel=false#6.18/39.46/2.667");
        islandChainRepo.save(balearicIsland);

        IslandChainModel campanianIsland = new IslandChainModel("Campanian Archipelago", italy, tyrrhenianSea,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/cstephens/cky2cwav41al814o5n98c52su.html?title=false&access_token=pk.eyJ1IjoiY3N0ZXBoZW5zIiwiYSI6ImNreTJjc2tzYjBqbXQydW1wZ2N0a20zeDYifQ.SkbSfO39uFF6KHu0Jm7ISA&zoomwheel=false#8.68/40.6253/14.1745");
        islandChainRepo.save(campanianIsland);

        IslandChainModel hawaiianIsland = new IslandChainModel("Hawaiian Islands", usa, pacificOcean,bassIslandsItinerary,bassIslandsPackList, "https://api.mapbox.com/styles/v1/cstephens/cky2cwav41al814o5n98c52su.html?title=false&access_token=pk.eyJ1IjoiY3N0ZXBoZW5zIiwiYSI6ImNreTJjc2tzYjBqbXQydW1wZ2N0a20zeDYifQ.SkbSfO39uFF6KHu0Jm7ISA&zoomwheel=false#5.55/19.731/-157.586");
        ...
        IslandChainModel caboVerdeIsland = new IslandChainModel("Cabo Verde", republicOfCaboVerde, atlanticOcean, bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/cstephens/cky2cwav41al814o5n98c52su.html?title=false&access_token=pk.eyJ1IjoiY3N0ZXBoZW5zIiwiYSI6ImNreTJjc2tzYjBqbXQydW1wZ2N0a20zeDYifQ.SkbSfO39uFF6KHu0Jm7ISA&zoomwheel=false#6.47/15.548/-23.935");
        islandChainRepo.save(caboVerdeIsland);

        IslandChainModel praslinIsland = new IslandChainModel("Praslin Island", republicOfSeychelles, indianOcean,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#4.09/-5.98/50.55");
        islandChainRepo.save(praslinIsland);

        IslandChainModel philippinesIsland = new IslandChainModel("Philippines", countryPhilippines, southChinaSea, bassIslandsItinerary, bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#3.79/11/122.92");
        islandChainRepo.save(philippinesIsland);

        IslandChainModel corfuIsland = new IslandChainModel("Corfu",greece,ionianSea,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#8.64/39.6228/19.8716");
        ...
        IslandChainModel mallorcaIsland = new IslandChainModel("Mallorca",spain,mediterraneanSea,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#7.57/39.536/2.929");
        islandChainRepo.save(mallorcaIsland);

        IslandChainModel ibizaIsland = new IslandChainModel("Ibiza",spain,mediterraneanSea,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#7.85/38.934/1.396");
        islandChainRepo.save(ibizaIsland);

        IslandChainModel formenteraIsland = new IslandChainModel("Formentera",spain,mediterraneanSea,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#10.07/38.7004/1.472");
        islandChainRepo.save(formenteraIsland);

        IslandChainModel capriIsland = new IslandChainModel("Capri",italy,tyrrhenianSea,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#11.11/40.5452/14.2339");
        islandChainRepo.save(capriIsland);

        IslandChainModel ischiaIsland = new IslandChainModel("Ischia",italy,tyrrhenianSea,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#9.73/40.7305/13.9433");
        islandChainRepo.save(ischiaIsland);

        IslandChainModel ponzaIsland = new IslandChainModel("Ponza",italy,tyrrhenianSea,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#10.24/40.9038/12.9704");
        islandChainRepo.save(ponzaIsland);

        IslandChainModel hvarIsland = new IslandChainModel("Hvar",croatia,adriaticSea,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#10.22/43.177/16.4478");
        islandChainRepo.save(hvarIsland);

        IslandChainModel kauaiIsland = new IslandChainModel("Kauai",usa,pacificOcean,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#8.56/22.0832/-159.515");
        islandChainRepo.save(kauaiIsland);

        IslandChainModel oahuIsland = new IslandChainModel("Oahu",usa,pacificOcean,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#8.52/21.5054/-157.9293");
        islandChainRepo.save(oahuIsland);

        IslandChainModel mauiIsland = new IslandChainModel("Maui",usa,pacificOcean,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#8.35/20.843/-156.341");
        ...
        IslandChainModel ungujaIsland = new IslandChainModel("Unguja",tanzania,indianOcean,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#10.63/-6.1226/39.3652");
        islandChainRepo.save(ungujaIsland);

        IslandChainModel iihaGrandeIsland = new IslandChainModel("Iiha Grande",brazil,atlanticOcean,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#9.34/-23.829/-45.3268");
        islandChainRepo.save(iihaGrandeIsland);

        IslandChainModel chiloeIsland = new IslandChainModel("Chiloe",chile,pacificOcean,bassIslandsItinerary,bassIslandsPackList,"https://api.mapbox.com/styles/v1/mbarkley23/cky2c4rxe1pu815nzdmq48ta6.html?title=copy&access_token=pk.eyJ1IjoibWJhcmtsZXkyMyIsImEiOiJja3kyYzIyY2Qwamt4MzN0NWt5N2lhdWswIn0.rxZNbrc8-0SzQlOABDaubQ&zoomwheel=true&fresh=true#6.71/-42.658/-73.819");
